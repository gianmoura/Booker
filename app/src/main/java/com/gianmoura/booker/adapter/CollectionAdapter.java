        ...
        RecyclerView.Adapter<CollectionAdapter.InnerViewHolder>
{
    ...
    private void showOfferDialog(final Context context, final Book book) {
        ...
        Button offer = (Button) customModal.getView().findViewById(R.id.dialog_offer_button_yes);
...
//                createOffer();
        ...
        Button cancel = (Button) customModal.getView().findViewById(R.id.dialog_offer_button_no);
